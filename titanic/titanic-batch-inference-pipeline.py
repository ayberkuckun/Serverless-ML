...
def g():
    ...
    model = mr.get_model("titanic_last_modal", version=1)
    model_dir = model.download()
    model = joblib.load(model_dir + "/titanic_model.pkl")

    feature_view = fs.get_feature_view(name="titanic_last_modal", version=1)
    ...
    # print(y_pred)
    offset = 1
    outcome = y_pred[y_pred.size - offset]
    outcome_url = "https://raw.githubusercontent.com/ayberkuckun/Serverless-ML/main/titanic/images/" + str(outcome) + ".png"
    print("Outcome predicted: " + str(outcome))
    ...
    label_url = "https://raw.githubusercontent.com/ayberkuckun/Serverless-ML/main/titanic/images/" + str(int(label)) + ".png"
    ...
    print("Number of different outcome predictions to date: " + str(predictions.value_counts().count()))
